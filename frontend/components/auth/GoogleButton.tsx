...
const GoogleButton: React.FC<GoogleButtonProps> = ({ text }) => {
    ...
    return (
        <button
            className={`flex w-full items-center text-gray-600 justify-center gap-4 rounded-full border border-stroke bg-gray-2 p-[15px] font-medium hover:bg-opacity-50 ${
